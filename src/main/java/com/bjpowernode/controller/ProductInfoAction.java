...
public class ProductInfoAction {
    ...
    public void condition(ProductInfoVo vo ,HttpServletRequest session){
    ...
    public String save(ProductInfo info,HttpServletRequest request){
        ...
        //info对象中有表单提交上来5个数据，有异步ajax上来的图片名称的数据，有上架时间的数据
        int num = -1;
        try {
        ...
        saveFileName = "";
        //增加成功后应该重新访问数据库，所以跳转到到分页显示的action上
    ...
    public String update(ProductInfo info,HttpServletRequest request){
        //因为ajax的异步图片上传，如果有上传过，则saveFileName里有上传上来的图片的名称，如果没有使用异步ajax
        //上传过图片，则saveFileName等于空,实体类info使用隐藏表单域提供上来的pImage
        //原始图片的名称；
        ...
        //完成更新操作
        int num = -1;
        //对于增删改的操作，一定要增加try,catch的异常捕获操作
        try {
        ...
        //处理完更新后，saveFileName里有可能有数据，而下一次更新或新增要使用这个变量作为判断的依据，
        //所以必须清空saveFileName,
        saveFileName = "";
        return "forward:/prod/split.action";
    }
